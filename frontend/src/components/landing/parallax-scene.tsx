...
export function ParallaxScene() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <Parallax
        speed={-20}
        className="absolute top-12 left-4 md:top-20 md:left-12"
      >
        <Cloud size="lg" />
      </Parallax>
      <Parallax
        speed={-18}
        className="absolute top-24 right-12 md:top-32 md:right-1/4"
      >
        <Cloud size="md" />
      </Parallax>
      <Parallax
        speed={-15}
        className="absolute top-40 left-1/3 hidden md:block"
      >
        <Cloud size="sm" />
      </Parallax>
      <Parallax
        speed={-22}
        className="absolute top-16 left-1/2 hidden lg:block"
      >
        <Cloud size="md" />
      </Parallax>
      ...
      <Parallax
        speed={-12}
        className="absolute bottom-32 md:bottom-48 left-0 right-0"
      >
        <svg
      ...
      <Parallax
        speed={-8}
        className="absolute bottom-24 md:bottom-36 left-0 right-0"
      >
        <svg
          viewBox="0 0 1440 320"
      ...
      <Parallax
        speed={0}
        className="absolute bottom-16 md:bottom-24 left-0 right-0  -z-50"
      >
        <div className="bg-green-300 w-full h-80 md:h-100"></div>
      </Parallax>

      {/* Trees on hills */}
      <Parallax
        speed={-5}
        className="absolute bottom-28 md:bottom-40 left-8 md:left-16"
      >
        <Tree size="lg" />
      </Parallax>
      <Parallax
        speed={-4}
        className="absolute bottom-24 md:bottom-32 left-20 md:left-32"
      >
        <Tree size="md" />
      </Parallax>
      <Parallax
        speed={-6}
        className="absolute bottom-32 md:bottom-48 right-12 md:right-24"
      >
        <Tree size="lg" />
      </Parallax>
      <Parallax
        speed={-3}
        className="absolute bottom-20 md:bottom-28 right-24 md:right-48"
      >
        <Tree size="sm" />
      </Parallax>
      <Parallax
        speed={-5}
        className="absolute bottom-28 md:bottom-36 left-1/3 hidden md:block"
      >
        <Tree size="md" />
      </Parallax>
      ...
      <Parallax
        speed={-28}
        translateX={[20, -20]}
        className="absolute top-36 left-1/3 hidden md:block"
      >
        <Bird />
      </Parallax>
      <Parallax
      ...
      <Parallax speed={0} className="absolute bottom-15 left-0 right-0">
        <svg
          viewBox="0 0 1440 120"
          className="w-full h-30 md:h-40"
          preserveAspectRatio="none"
        >
          <path
            fill="rgb(34, 197, 94)"
      ...
      <Parallax
        speed={-2}
        rotate={[-5, 5]}
        className="absolute bottom-15 md:bottom-20 left-1 md:left-10"
      >
        <FloatingPet emoji="🐕" />
      </Parallax>
      <Parallax
        speed={-8}
        rotate={[5, 10]}
        className="absolute bottom-40 md:bottom-56 right-12 md:right-25"
      >
        <FloatingPet emoji="🐱" />
      </Parallax>
      <Parallax
        speed={-5}
        rotate={[-3, 3]}
        className="absolute bottom-48 md:bottom-50 left-1/4 hidden md:block"
      >
        <FloatingPet emoji="🐰" />
      </Parallax>
...
function Cloud({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-white rounded-full blur-sm z-0" />
      <div className="absolute w-1/2 h-1/2 bg-white rounded-full z-10" />
      <div className="absolute w-2/3 h-3/4 bg-white rounded-full z-10" />
    </div>
  );
}
