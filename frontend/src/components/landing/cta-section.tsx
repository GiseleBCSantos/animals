...
export function CTASection() {
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <Parallax
        speed={-15}
        className="absolute top-8 left-8 md:left-16 pointer-events-none"
      >
      ...
      <Parallax
        speed={-12}
        className="absolute top-16 right-12 md:right-32 pointer-events-none"
      >
      ...
      <Parallax
        speed={-20}
        rotate={[-15, 15]}
        className="absolute top-1/4 left-8 md:left-20 pointer-events-none"
      >
      ...
      <Parallax
        speed={-18}
        rotate={[10, -10]}
        className="absolute top-1/3 right-8 md:right-16 pointer-events-none"
      >
