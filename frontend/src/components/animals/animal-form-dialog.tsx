...
export function AnimalFormDialog({ open, onOpenChange, animal, onSubmit }: AnimalFormDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>{animal ? "Editar Pet" : "Adicionar Novo Pet"}</DialogTitle>
        </DialogHeader>
          ...
          {({ values, errors, touched, isSubmitting, setFieldValue }) => (
            <Form className="space-y-4">
              <div className="space-y-2">
                ...
                <Field as={Input} id="name" name="name" placeholder="Nome do seu pet" />
                {errors.name && touched.name && <p className="text-sm text-destructive">{errors.name}</p>}
              </div>

              <div className="space-y-2">
                <Label htmlFor="species">Especie *</Label>
                <Select value={values.species} onValueChange={(value) => setFieldValue("species", value)}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Field as={Input} id="breed" name="breed" placeholder="Raca do seu pet (opcional)" />
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {errors.age && touched.age && <p className="text-sm text-destructive">{errors.age}</p>}
              </div>
